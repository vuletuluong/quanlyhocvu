    ...
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <ul class="list-unstyled py-4">
          ...
          <li class="sidebar-item"><a class="sidebar-link" href="xoataikhoan.php">
            <svg class="svg-icon svg-icon-sm svg-icon-heavy me-xl-2">
            ...
            <div class="container-fluid">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 py-3">
                  ...
                  <li class="breadcrumb-item active fw-light" aria-current="page">Thông tin môn học</li>
                </ol>
              </nav>
            </div>
          </div>
                  ...
                  <div class="card mb-0">
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        ...
                        <?php 
						$_idtk=$_SESSION['id'];
						$_sql="SELECT`id_sinhvien`FROM sinhvien WHERE id_taikhoan='$_idtk'";
						$id_sv=$p->laycot($_sql);
						
					   	$_sqlidmh=("SELECT * FROM sinhvien AS A INNER JOIN `lophocphan` AS B ON B.id_sinhvien = A.id_sinhvien INNER JOIN `monhoc` AS C ON C.id_monhoc = B.id_monhoc WHERE A.Id_sinhvien='$id_sv'");
						$p->load_ds_lhp("$_sqlidmh");
