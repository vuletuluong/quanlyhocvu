          ...
          <div class="container-fluid">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 py-3">
                ...
                <li class="breadcrumb-item active fw-light" aria-current="page">Thêm môn học</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Thêm môn học</h3>
                  </div>
                  ...
                  <!---------KIEM TRA------------------------------------------------>
					<?php	
							...
							if ($_SERVER["REQUEST_METHOD"] == "POST") {
								...
								if (empty($_POST["tenmonhoc"])) {
									...
									$tenmonhoc =$q-> input_data($_POST["tenmonhoc"]);
								...
								if (empty($_POST["namhoc"])) {
									...
									$diachi =$q-> input_data($_POST["namhoc"]);
									
									
									
									if (!preg_match ("/^([1-9]?)[0-9]{3}$/", $namhoc) ) 
									{
										$namhocErr = "Năm học không hợp lệ";
									}
						...
						if(isset($_POST['nut']))
							switch($_POST['nut'])
							{
								case'Save changes':
								{
									...
									/*echo $id_taikhoan,$diachi,$email,$lop,$hovaten ;*/
									if( $tenmhErr=='' && $thoigianhocErr=='' && $namhocErr  =='' )
									{
					
											if($p->themxoasua("INSERT INTO monhoc ( tenmh, thoigianhoc, namhoc) VALUES ( '$tenmonhoc', '$thoigianhoc','$namhoc');")==1)
											{
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="form-horizontal"  >
                      <div class="row">
                        <label class="col-sm-3 form-label">Tên môn học</label>
                        <div class="col-sm-9">
                          <input name="tenmonhoc" class="form-control"  value=" <?php  echo trim($tenmonhoc); ?>"   type="text">
                          <span class="error" style="color:red;" >* <?php  echo $tenmhErr; ?> </span>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <input name="thoigianhoc" type="text" value=" <?php echo trim($thoigianhoc); ?>" class="form-control" id="thoigianhoc">
                          <span class="error" style="color:red;">* <?php  echo $thoigianhocErr; ?> </span>
                        </div>
                      </div>
                      <div class="border-bottom my-5 border-gray-200"></div>
                      <div class="row">
                        <label  class="col-sm-3 form-label">Năm học</label>
                        <div class="col-sm-9">
                          <input name="namhoc" type="text" value=" <?php echo trim($namhoc); ?>" class="form-control" id="namhoc">
                          <span class="error" style="color:red;">* <?php  echo $namhocErr; ?> </span>
