                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                       <?php 
						...
						$id_sv=$p->laycot($_sql);
					   	$_sqlidmh=("SELECT * FROM sinhvien AS A INNER JOIN `lophoc` AS B ON B.id_sinhvien = A.id_sinhvien INNER JOIN `monhoc` AS C ON C.id_monhoc = B.id_monhoc WHERE A.Id_sinhvien='$id_sv'");
