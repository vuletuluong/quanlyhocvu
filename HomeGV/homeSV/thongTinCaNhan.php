            ...
            <nav class="side-navbar z-index-40">
                ...
                <div class="sidebar-header d-flex align-items-center py-4 px-3"><img
                    ...
                    <div class="ms-3 title">
                        <h1 class="h4 mb-2"><a href="danhsachtaikhoan.php"><?php echo $_SESSION['tennguoidung'] ?></a></h1>
                                ...
                                <div class="card mb-0">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            ...
                                            <?php 
											if($_SESSION['phanquyen']=='sinh viên')
											{
												if(is_numeric($idsv))
												{
													$a->load_ds_sinhvien("select * from sinhvien where id_taikhoan='$idsv' limit 1; ");
