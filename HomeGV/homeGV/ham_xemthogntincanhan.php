		...
		public function load_ds_lhp_gv($sql)
	{
		...
		if($i>0)
		{
			...
			while($row=mysqli_fetch_array($ketqua))
			{
				...
				echo'<tbody>
                          <tr>
                            <th scope="row"><a href="uploadfile.php?id='.md5($id).'">'.$tenlhp.'</a></th>
                            <td><a href="uploadfile.php?id='.md5($id).'">'.$id.'</a></td>
                            <td><a href="uploadfile.php?id='.md5($id).'">'.$time.'</a></td>
							<td><a href="uploadfile.php?id='.md5($id).'">'.$namhoc.'</a></td>
