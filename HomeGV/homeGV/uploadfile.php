              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <h3 class="h4 mb-0">Upload file</h3>
                  </div>
                  <div class="card-body">
					 ...
					 <?php
                        ...
                        switch($_POST['nut'])
                        {
                            case'Thêm':
                            {
                                ...
                                if($name && $tenfile &&$size<100000 && $ngaydang !='' && $type=='application/x-zip-compressed')
								
								
								
                                {          $name=$_SESSION['id']."_".$name;
                                            if($p->uploadfile($name,$tmp_name,"folder")==1)
                                            {
                                                if($p->themxoasua("INSERT INTO file(tenfile,ngaydang,id_nguoidung,name_file,id_monhoc)VALUES( '$name', '$ngaydang','$id_nguoidung','$tenfile','$id_monhoc')")==1)
                                                {
                        ...
                        ?>
                                                <?php
							$p->loaddanhsachfile("SELECT name_file FROM file where id_monhoc='$id_monhoc' ;");
						?>
