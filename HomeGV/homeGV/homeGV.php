        ...
        <ul class="list-unstyled py-4">
          ...
          <li class="sidebar-item"><a class="sidebar-link" href="#exampledropdownDropdownm" data-bs-toggle="collapse">
            ...
            <ul class="collapse list-unstyled " id="exampledropdownDropdownm">
              <li><a class="sidebar-link" href="danhSachLHP.php">Thêm tài khoản</a></li>
              <li><a class="sidebar-link" href="taoLHP.php">Xóa tài khoản</a></li>
              <li><a class="sidebar-link" href="chopLopTruong.php">Sửa tài khoản</a></li>
            </ul>
          </li>
          ...
          <ul class="collapse list-unstyled " id="exampledropdownDropdow">
            <li><a class="sidebar-link" href="taoPass.php">Thêm sinh viên</a></li>
            <li><a class="sidebar-link" href="taoPass.php">Xóa sinh viên</a></li>
            <li><a class="sidebar-link" href="taoPass.php">Sửa thông tin sinh viên</a></li>
          </ul>
        </li>
          ...
          <li class="sidebar-item"><a class="sidebar-link" href="#exampledropdownDropdown" data-bs-toggle="collapse">
            ...
            <ul class="collapse list-unstyled " id="exampledropdownDropdown">
              <li><a class="sidebar-link" href="uploadfile.php">Thêm giảng viên</a></li>
              <li><a class="sidebar-link" href="danhSachHDNK.php">Xóa giảng viên</a></li>
              <li><a class="sidebar-link" href="xacnhanBC.php">Sửa thông tin giảng viên</a></li>
            </ul>
          </li>
          ...
          <ul class="collapse list-unstyled " id="exampledropdownDropdownmm">
            <li><a class="sidebar-link" href="tongHopDiemDanh.php">Thêm môn học</a></li>
            <li><a class="sidebar-link" href="tongHopTichCuc.php">Xóa môn học </a></li>
            <li><a class="sidebar-link" href="tongHopTichCuc.php">Thêm môn học </a></li>
          </ul>
        </li>
      ...
      <div class="content-inner w-100">
        ...
        <header class="bg-white shadow-sm px-4 py-3 z-index-20">
          <div class="container-fluid px-0">
            <h2 class="mb-0 p-1" style="text-align:center;">Quản lý học tập</h2>
          </div>
        </header>
